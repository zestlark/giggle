  ...
  return (
    <BackgroundWrapper>
      <div className="flex flex-col justify-center items-center bg-red-300/10 min-h-screen bg-gradient-to-b from-transparent to-black/80">
        ...
        <p className="text-white mt-0 -md:mt-[50px] mb-[30px] max-w-[500px] text-center">where every tale brings laughter and adventure! magical worlds filled with fun and friends</p>
        <Link href="/stories">
